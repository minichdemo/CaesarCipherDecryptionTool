...
###Step 6: Write a formula to convert the shifted numbers to ASCII characters
...
###Step 7: Change the amount of `shift`
...
###Step 8: Use `MOD` to wrap the letters back to `A`
...
###Step 9: Test your decryption tool
...
###Step 10: Decrypt 5 secret messages
